...
const styles = StyleSheet.create({
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#06081A', padding: 0 },
  tableHeaderCell: {
    color: 'white',
    fontFamily: 'Helvetica-Bold',
    fontSize: 8,
  ...
  ccpAlert: { fontSize: 8, marginTop: 3, color: '#ED2939', fontFamily: 'Helvetica-Bold' },
  // ── Footer ───────────────────────────────────────────────
  footer: {
    position: 'absolute',
    bottom: 20,
