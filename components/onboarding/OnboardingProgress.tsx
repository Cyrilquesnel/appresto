  ...
  const steps = [
    {
      ...
      done: data.steps.type_etablissement,
      href: '/onboarding',
    },
    {
      key: 'premier_plat',
      label: 'Premier plat',
      done: data.steps.premier_plat,
      href: '/plats/nouveau',
    },
    {
      key: 'premiers_prix',
      label: 'Prix en mercuriale',
      done: data.steps.premiers_prix,
      href: '/mercuriale',
    },
    {
      key: 'premiere_commande',
      label: 'Première commande',
      done: data.steps.premiere_commande,
