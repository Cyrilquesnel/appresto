...
export function VentesSemaineChart({ data }: VentesSemaineChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-4" data-testid="ventes-semaine-chart">
      <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-3">7 derniers jours</p>
